...
// Vertical-specific pain point openers
...
<p>👉 2-min demo call: <a href="${trackingUrl}" style="color:#e8930c;font-weight:600;">${trackingUrl}</a></p>
<p>Or call our demo agent yourself: <strong>${demoPhone}</strong> - takes 60 seconds.</p>
<p>If the timing's not right, no worries at all.</p>
<p>Lars<br/><span style="${SIG_STYLE}">(832) 346-6405</span></p>
</div>`,
    };
  }

  // === FIRST TOUCH (one template, vertical-specific opener) ===
  return {
    subject: `24/7 answering + booking for ${biz}`,
    html: `<div style="${STYLE}">
<p>${greet}</p>
<p>${pain}</p>
<p>I founded Supportive AI, a 24/7 receptionist built for ${trade} that:</p>
<ul style="padding-left:20px;margin:12px 0;">
<li style="margin-bottom:6px;">answers every call - nights, weekends, holidays</li>
<li style="margin-bottom:6px;">books jobs into your live Google Calendar</li>
<li style="margin-bottom:6px;">flags emergencies and texts you immediately</li>
<li style="margin-bottom:6px;">keeps your existing number (or creates a new one)</li>
<li style="margin-bottom:6px;">sends payment links after the job</li>
</ul>
<p>Want to hear what it sounds like? 👉 2-min demo call: <a href="${trackingUrl}" style="color:#e8930c;font-weight:600;">${trackingUrl}</a></p>
<p>I'll give you a quick call in the next few days.</p>
<p>If you want to try it before I ring, set up a free trial - fully configured for ${biz}. Takes 2 minutes: <a href="${SITE_URL}/onboarding" style="color:#e8930c;">supportive-ai.com/onboarding</a></p>
<p>Best,<br/>Lars Beurskens<br/><span style="${SIG_STYLE}">Founder, Supportive AI<br/>(832) 346-6405<br/><a href="${SITE_URL}" style="color:#5a7184;">supportive-ai.com</a></span></p>
<p style="color:#94a7b8;font-size:13px;">P.S. Free 7-day trial, no card needed - hear how your AI receptionist sounds.</p>
</div>`,
  };
}
