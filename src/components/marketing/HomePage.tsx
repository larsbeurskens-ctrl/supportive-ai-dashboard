    ...
    <>
      ...
      <section id="how-it-works" className="py-16 px-6 md:px-10 max-w-[860px] mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row gap-8 md:gap-0">
          ...
          {[
            { n: '1', title: 'Sign up & name your AI', desc: 'Create your account. Pick a local area code. Your AI gets its own number.' },
            { n: '2', title: 'Add your business details', desc: 'Tell it your pricing, services, hours, and credentials. Takes 2 minutes.' },
            { n: '3', title: 'Test it with a real call', desc: 'Call your AI number. Book a job, ask about pricing, try a reschedule. Happy? Go live.' },
            { n: '4', title: 'Forward your existing number', desc: 'Keep the number on your van. One short code forwards missed calls to your AI. Done.' },
          ].map((s, i) => (
