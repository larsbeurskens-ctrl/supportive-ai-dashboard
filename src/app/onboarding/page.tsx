        ...
        <div className="w-full max-w-[440px]">
          ...
          <div className="bg-white rounded-2xl border border-[#e5e0da] p-7 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="website" className="block text-sm font-semibold text-[#1a2e3b] mb-1.5">Website <span className="font-normal text-[#94a7b8]">(optional)</span></label>
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#e5e0da] rounded-xl text-[15px] text-[#1a2e3b] placeholder:text-[#b8c4ce] focus:outline-none focus:ring-2 focus:ring-[#e8930c] focus:border-transparent bg-white"
                />
                <p className="text-[12px] text-[#94a7b8] mt-1">We&apos;ll use this to pre-fill your pricing and services during setup</p>
              </div>
